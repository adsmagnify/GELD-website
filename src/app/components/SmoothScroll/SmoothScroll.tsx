...
export default function SmoothScroll() {
  ...
  useEffect(() => {
    ...
    // Disable JS scroll snapping assistant on mobile viewports (width <= 768px).
    // Mobile will use native CSS y-proximity snaps which allow free scrolling
    // and snap only when stopping near section boundaries.
